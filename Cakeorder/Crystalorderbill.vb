...
Public Class Crystalorderbill
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cakeorder.Crystalorderbill.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ono() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrystalorderbill
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystalorderbill = New Crystalorderbill
        rpt.Site = Me.Site
        Return rpt
    End Function
